...
session_start();
    ...
    if(isset($_POST['edituser'])){
        ...
        $query = "UPDATE signup SET name='$name',password='$pass',gender='$gender',dob='$dob',phone='$phone',role='$role' WHERE email='$email'";
                ...
                <form method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password"  name= "password" class="form-control" value="<?php if(isset($_GET['email']))echo $r[2] ?>">
                    </div>
                    ...
                    <button type="submit" name="edituser" class="btn btn-primary">Update Details</button>
                </form>
            </div>
